...
<a href="Titans_of_Ul.md" download class="download-link" title="Plain text file - safe to download">Download .md</a>
</nav>
...
3. [Faction Info and Drafting](#iii-faction-info-and-drafting)
   - [Home System & Commodities](#a-home-system--commodities) · [Starting Fleet](#b-starting-fleet) · [Faction Abilities](#c-faction-abilities) · [Technologies](#d-starting-and-faction-technologies) · [Leaders](#e-leaders) · [Promissory Note](#f-promissory-note) · [Alliance](#g-alliance) · [Mech](#h-mech) · [Flagship](#i-flagship) · [Special Units](#j-hel-titan-i---ul-pds-special-unit) · [Breakthrough](#l-breakthrough---slumberstate-computing-yg) · [Slice and Draft](#m-slice-and-draft-considerations)
4. [Round 1 Problems and Faction Weakness](#iv-round-1-problems-and-faction-weakness)
   - [First Turn Priorities](#a-first-turn-priorities) · [Commander Dependency](#b-commander-dependency) · [Political Weakness](#c-political-weakness) · [Sleeper Token Telegraphing](#d-sleeper-token-telegraphing)
5. [Technology](#v-technology)
   - [Overview](#a-overview) · [Special Unit Upgrades Path](#b-tech-path-1-special-unit-upgrades-standard) · [Economic Focus Path](#c-tech-path-2-economic-focus-alternative)
...
Playing Titans means swinging one of the strongest fleets in the game while maintaining impenetrable defenses. Your Saturn Engine cruisers aren't normal cruisers—upgraded, they're fast mobile capital ships with Sustain Damage that carry troops anywhere. Your Hel-Titan PDS networks defend your territory while producing ships wherever your fleet needs reinforcements.

Your early game focuses on excavation. Explore planets with Scanlink, place sleeper tokens with Terragenesis, then awaken them into infrastructure. Your Commander unlocks and transforms your economy—every production generates trade goods. This wealth funds your elite cruiser fleet while Hel-Titan networks provide distributed production.

As the game progresses, your Saturn Engine fleet projects force across the map while Hel-Titans defend your controlled territory. Distributed production means you build ships wherever needed. Your cruisers swing between objectives, leveraging mobility and Sustain Damage to dominate contested space. Defensive networks keep your home secure while your fleet operates freely.

Your endgame combines overwhelming force with total security. Your cruiser fleet is elite. Your defensive infrastructure is impenetrable. Commander has generated massive wealth. Structure objectives are free. You control the map through mobility and production dominance.
...
- **Elysium:** 4 resources / 1 influence = 4 optimal resources
- **Total: 4 resources / 1 influence (4 optimal resources)**

**Commodities:** 2

**Notes:** Very strong defensive home. Single planet with Hero becomes 7/4 late game for extreme production capacity. Low commodities (2) means economy comes from Commander, not trade.

### B. Starting Fleet

- 1 Dreadnought
- 2 Cruisers (Saturn Engine I)
- 2 Fighters
- 3 Infantry
- 1 Space Dock

**Notes:** Strong combat start with dreadnought. 3 infantry can feel lacking, but Saturn Engine cruisers with move 2 make you very flexible for any slice.
...
Place sleeper tokens on explored planets. Scanlink explores planets every activation, generating constant sleeper placement opportunities. Combos with Slumberstate Computing breakthrough—negotiate to place sleepers on opponents' planets.
...
Setup all structures for free. If critically need mobile ground forces, use mech DEPLOY to make mech + infantry instead of PDS.
...
Standard production bonus for ally. Trade value: 2-3 TG.
...
- **Hel-Titans** - PDS across the galaxy for distributed production and defense.
- **Saturn Engine Cruisers** - Your core fleet. Elite mobility and Sustain Damage when upgraded.
- **Dreadnought** - Heavy combat support.
- **Infantry** - Ground forces from distributed production.
- **Flagship** - Teleports via PDS network.

Focus on Saturn Engine cruiser fleet with Hel-Titan production support. Cruisers are your primary force projection tool.
