...
The Clan of Saar are Twilight Imperium's **mobile production masters**, the only faction whose space docks float in space, move like ships, and produce without controlling planets. Your unique Floating Factories (space docks with movement, capacity, and the ability to retreat) break fundamental TI4 rules: you don't need planets for production, you can relocate your infrastructure instantly, and your Nomadic ability lets you score objectives even if you abandon your home system entirely. You start with Antimass Deflectors (free movement boost), field 2 carriers for early mobility, and leverage Scavenge (gain 1 trade good per planet conquered) for economic acceleration. This faction rewards aggressive expansion, positional flexibility, and understanding when to float your factories forward versus when to consolidate. No faction matches Saar's ability to project production anywhere on the map.

## II. Playstyle

**Early Game (Rounds 1-2):**
Your opening focuses on leveraging your mobile Floating Factory to claim high-value systems without traditional planet control. Move your starting space dock (Floating Factory I) to a resource-rich system (3-4 resources) and produce ships directly in space, bypassing the need to control planets. Your Scavenge ability generates 1 trade good every time you conquer a planet, creating economic snowball when combined with aggressive expansion. Start with Antimass Deflectors (0-cost tech, grants +1 movement to ships with capacity), giving your 2 starting carriers movement 2 immediately. This mobility lets you reach distant high-value systems Round 1. Your Nomadic ability means you can abandon your home system (Lisis II + Ragh) without penalty—as long as you score objectives, home control is irrelevant. Expand aggressively: conquer 3-4 planets Round 1-2 to trigger Scavenge repeatedly.

**Mid Game (Rounds 3-4):**
This is when Saar's mobile production dominates. Your commander (Rowl Sarring) unlocks with 3 space docks on board, granting the ability to place fighters/infantry at ANY non-blockaded space dock when producing them. Combined with 2-3 Floating Factories positioned strategically, you can produce infantry at one space dock and deploy them instantly at another across the map. Research Floating Factory II (2 yellow prerequisites) to upgrade your space docks to movement 2, capacity 5, and production 7—incredible infrastructure units. Your Chaos Mapping faction tech (1 blue prerequisite) prevents opponents from activating asteroid fields containing your ships AND lets you produce 1 unit at start of turn in any system with your production units. Build 2-3 Floating Factories total, positioning them near contested areas (Mecatol, opponent slices, objective-relevant systems). Your hero (Gurno Aggero) unlocks Round 3-4, allowing you to destroy all enemy infantry/fighters in a system adjacent to your space dock—devastating area denial.
