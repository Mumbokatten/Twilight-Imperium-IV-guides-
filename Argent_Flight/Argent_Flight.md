...
3. [Faction Info and Drafting](#iii-faction-info-and-drafting)
   - [Home System & Commodities](#a-home-system--commodities) · [Starting Fleet](#b-starting-fleet) · [Faction Abilities](#c-faction-abilities) · [Technologies](#d-starting-and-faction-technologies) · [Leaders](#e-leaders) · [Promissory Note](#f-promissory-note---strike-wing-ambuscade) · [Alliance](#g-alliance) · [Mech](#h-mech---aerie-sentinel) · [Flagship](#i-flagship---quetzecoatl) · [Breakthrough](#j-breakthrough---wing-transfer-by) · [Slice and Draft](#k-slice-and-draft-considerations)
4. [Round 1 Problems and Faction Weakness](#iv-round-1-problems-and-faction-weakness)
   - [First Turn Priorities](#a-first-turn-priorities) · [Late Game Scaling](#b-late-game-scaling)
5. [Technology](#v-technology)
   - [Overview](#a-overview) · [Tech Path](#b-tech-path-standard) · [Diversions](#c-diversions)
...
7. [Unit Composition and Game Plan](#vii-unit-composition-and-game-plan)
   - [Unit Composition](#a-unit-composition) · [Custodian Strategy](#b-custodian-strategy)
...
- 1 Carrier
- 2 Destroyers (Strike Wing Alpha I)
- 2 Fighters
- 5 Infantry
- 1 Space Dock
- 1 PDS
...
**Recommended:** **<span class="ty">Sarween Tools</span> + <span class="tr">Plasma Scoring</span>** - This is the only reasonable choice. Gives you flexibility and enables easy expansion. Sarween provides economy and leads to <span class="ty">Aerie Hololattice</span> <img src="../icons/tech_cybernetic.svg" class="tech-icon" alt="Y"> if going structure path. <span class="tr">Plasma Scoring</span> leads to <span class="tr">Strike Wing Alpha II</span> <img src="../icons/tech_warfare.svg" class="tech-icon" alt="R"><img src="../icons/tech_warfare.svg" class="tech-icon" alt="R">. <span class="tg">Neural Motivator</span> is bait—green doesn't lead to any techs Argent actually wants.

**Faction Technologies:**

You typically acquire both faction technologies during the game.

**<span class="tr">Strike Wing Alpha II</span> <img src="../icons/tech_warfare.svg" class="tech-icon" alt="R"><img src="../icons/tech_warfare.svg" class="tech-icon" alt="R">:**
...
**<span class="ty">Aerie Hololattice</span> <img src="../icons/tech_cybernetic.svg" class="tech-icon" alt="Y">:**
...
**Alliance Ability:**
*While the Argent Flight player's commander is unlocked:*
*When 1 or more of your units make a roll for a unit ability, you may choose 1 of those units to roll 1 additional die.*
...
You start with **TWO technologies of your choice** from <span class="tg">Neural Motivator</span> <img src="../icons/tech_biotic.svg" class="tech-icon" alt="G">, <span class="ty">Sarween Tools</span> <img src="../icons/tech_cybernetic.svg" class="tech-icon" alt="Y">, or <span class="tr">Plasma Scoring</span> <img src="../icons/tech_warfare.svg" class="tech-icon" alt="R">.
...
Your main tech path focuses on <span class="tr">Strike Wing Alpha II</span> <img src="../icons/tech_warfare.svg" class="tech-icon" alt="R"><img src="../icons/tech_warfare.svg" class="tech-icon" alt="R"> for destroyer dominance. Deviations available for structure setup if needed.

### B. Tech Path (Standard)

**Starting Tech Choices:** <span class="ty">Sarween Tools</span> <img src="../icons/tech_cybernetic.svg" class="tech-icon" alt="Y"> + <span class="tr">Plasma Scoring</span> <img src="../icons/tech_warfare.svg" class="tech-icon" alt="R">
...
**Round 1: <span class="tr">Magen Defense Grid</span> <img src="../icons/tech_warfare.svg" class="tech-icon" alt="R">**
...
**Round 2: <span class="ty">Aerie Hololattice</span> <img src="../icons/tech_cybernetic.svg" class="tech-icon" alt="Y"> - CAN DOUBLE TECH**
- Other players cannot move ships through systems that contain your structures. Each planet that contains 1 or more of your structures gains the PRODUCTION: 1 ability as if it were a unit.
...
**Round 3: <span class="tr">Strike Wing Alpha II</span> <img src="../icons/tech_warfare.svg" class="tech-icon" alt="R"><img src="../icons/tech_warfare.svg" class="tech-icon" alt="R"> - CAN DOUBLE TECH**
- Cost: 1 | Combat: 7 | Move: 2 | Capacity: 1 | ANTI-FIGHTER BARRAGE 6 (x3)
- When this unit uses ANTI-FIGHTER BARRAGE, each result of 9 or 10 also destroys 1 of your opponent's infantry in the space area of the active system.
...
- **<span class="tb">Gravity Drive</span> <img src="../icons/tech_propulsion.svg" class="tech-icon" alt="B">** - After you activate a system, apply +1 to the move value of 1 of your ships during this tactical action.
...
- **<span class="tb">Antimass Deflectors</span> <img src="../icons/tech_propulsion.svg" class="tech-icon" alt="B"> or <span class="tb">Dark Energy Tap</span> <img src="../icons/tech_propulsion.svg" class="tech-icon" alt="B">** - Get blue prerequisite to join tech path
...
**With Wing Transfer Breakthrough:**
1. <span class="tr">Magen Defense Grid</span> <img src="../icons/tech_warfare.svg" class="tech-icon" alt="R"> - Defense + free infantry
2. <span class="ty">Aerie Hololattice</span> <img src="../icons/tech_cybernetic.svg" class="tech-icon" alt="Y"> - Structure lockdown + production
3. <span class="tr">Strike Wing Alpha II</span> <img src="../icons/tech_warfare.svg" class="tech-icon" alt="R"><img src="../icons/tech_warfare.svg" class="tech-icon" alt="R"> - Destroyer power spike
4. <span class="tb">Gravity Drive</span> <img src="../icons/tech_propulsion.svg" class="tech-icon" alt="B"> + PDS II (RY) - Mobility + SPACE CANNON spam (double tech)
...
2. <span class="ty">Aerie Hololattice</span> <img src="../icons/tech_cybernetic.svg" class="tech-icon" alt="Y"> - Structure lockdown + production
3. <span class="tr">Strike Wing Alpha II</span> <img src="../icons/tech_warfare.svg" class="tech-icon" alt="R"><img src="../icons/tech_warfare.svg" class="tech-icon" alt="R"> - Destroyer power spike
4. <span class="tb">Antimass Deflectors</span>/<span class="tb">Dark Energy Tap</span> <img src="../icons/tech_propulsion.svg" class="tech-icon" alt="B"> + <span class="tb">Gravity Drive</span> <img src="../icons/tech_propulsion.svg" class="tech-icon" alt="B"> - Join blue tech path (double tech, skip PDS II)
5. Carrier II (BB) - Capacity
...
- **Note:** This path completely skips blue tech. Focus on red/yellow ship upgrades and use exploration to compensate for lack of mobility/capacity techs.
...
- **Destroyers (Strike Wing Alpha) + Fighter screen** - Core of your fleet for AFB and cheap production
- **1 Carrier** - For capacity and additional fighters
- **1 Flagship (optional)** - For additional combat hits and Sustain Damage
- **1-2 Dreadnoughts (if heavy resources)** - Add a few dreads if you have strong resource economy
- **1-2 Mechs** - Free capacity with Aerie Sentinel ability
...
8. **Muaat (Magmus)** - After you spend strategy token, gain 1 trade good. Economy boost for tech-focused playstyle.
